  ...
  switch (type) {
    ...
    case "checkbox":
      fields.push(
        ...
        generateField({
          id: crypto.randomUUID(),
          order: 33,
          frontendSlug: "checkboxOptionLabelFontSize",
        ...
        generateField({
          id: crypto.randomUUID(),
          order: 30,
          frontendSlug: "checkboxOptionLabelFontWeight",
          label: "Checkbox Option Label FontWeight",
          name: "optionFontWeight",
          options: fontWeights,
          type: "select",
          inputType: "select",
        ...
        generateField({
          ...
          label: "Checkbox Content Alingment",
          name: "checkboxContentAlingment",
          placeholder: "Select checkbox content alingment",
          type: "select",
          inputType: "select",
    ...
    case "toggle":
      fields.push(
        ...
        generateField({
          ...
          label: "Switch Track Background Color",
          type: "text",
          inputType: "text",
          placeholder: "#ffffff",
        }),
        ...
        generateField({
          ...
          label: "Switch Thumb Border Radius",
          type: "text",
          inputType: "text",
          placeholder: "10px",
        }),
        generateField({
          ...
          label: "Switch Thumb Background Color",
          type: "text",
          inputType: "text",
          placeholder: "10px",
        }),
    ...
    case "rating":
      fields.push(
        generateField({
          order: 40,
          frontendSlug: "ratingIconsAlignment",
          label: "Rating Icons Alignment",
        ...
        generateField({
          order: 40,
          frontendSlug: "ratingIconsGap",
          label: "Rating Icons Gap",
          type: "text",
          inputType: "text",
          placeholder: "10px",
        }),
